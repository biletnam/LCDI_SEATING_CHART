...
<div class="pageHeading">
  <table>
    <tr>
      <td><span class="pageHeading"><?php echo __('Time Log') ?></span></td>
      <td style="padding-left: 15px;"><?php echo __('Export') .': <a href="#" onClick="time_report_export(\'time_log_export\',\'csv\');">.csv</a> | <a href="#" onClick="time_report_export(\'time_log_export\', \'txt\');">.txt</a>' ?></td>          
    </tr>  
  </table>
</div>
  ...
  ?>
    <tr>
      ...
      <td><?php echo link_to($comments->getTasks()->getProjects()->getName(),'projectsComments/index?projects_id=' . $comments->getTasks()->getProjects()->getId(),array('class'=>'jt','rel'=>url_for('projects/info?id=' . $comments->getTasks()->getProjects()->getId()),'title'=>__('Project Info'),'target'=>'new')); ?></td>
    </tr>
  <?php 
...
<form action="<?php echo url_for('timeReport/export')?>" method="post" id="time_log_export">
  <?php echo input_hidden_tag('filename','time_log').input_hidden_tag('format').input_hidden_tag('export',serialize($export)) ?>
</form> 
...
<div class="pageHeading">
  <table>
    <tr>
      ...
      <td style="padding-left: 15px;"><?php echo __('Export') .': <a href="#" onClick="time_report_export(\'tasks_export\',\'csv\');">.csv</a> | <a href="#" onClick="time_report_export(\'tasks_export\', \'txt\');">.txt</a>' ?></td>          
    </tr>  
  </table>
</div>

  <table class="tableListing" id="tableListingTasks">
    <thead>
      <tr>
...
?>
  <tr>
    <td><?php echo link_to($tasks->getProjects()->getName(),'projectsComments/index?projects_id=' . $tasks->getProjects()->getId(),array('class'=>'jt','rel'=>url_for('projects/info?id=' . $tasks->getProjects()->getId()),'title'=>__('Project Infor'),'target'=>'new')); ?></td>
...
<form action="<?php echo url_for('timeReport/export')?>" method="post" id="tasks_export">
  <?php echo input_hidden_tag('filename','tasks').input_hidden_tag('format').input_hidden_tag('export',serialize($export)) ?>
</form> 

<script type="text/javascript">
  $(document).ready(function(){  
    $("#tableListingTasks").tablesorter({widgets: ['zebra']})   
  });     
</script>   
