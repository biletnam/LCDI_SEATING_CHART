...
class ticketsComponents extends sfComponents
{
  ...
  {  
    ...
    if(!$params)
    {
      ...
      $m = app::getFilterMenuItemsByTable($m,'ProjectsStatus','Case Status','tickets/index',$params);
      $m = app::getFilterMenuItemsByTable($m,'ProjectsTypes','Case Types','tickets/index',$params);      
    }
  ...
  public function executeFiltersPreview(sfWebRequest $request)
  {
    ...
    $this->filter_tables['Projects']='Cases'; //Changed may break    
    $this->filter_tables['ProjectsStatus']='Case Status';
    $this->filter_tables['ProjectsTypes']='Case Type';
