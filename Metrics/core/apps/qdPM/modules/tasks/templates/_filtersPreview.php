...
?>    
    <td>
      <div class="filterPreviewBox">
        <table>
          <tr>
            <td valign="top" style="padding-top: 2px;"><?php echo link_to(image_tag('icons/close_gray.png'),'tasks/index?remove_filter=' . $table . ($params? '&' . $params:''),array('title'=>__('Remove Filter')))?></td>
             ...
             {             
                switch($table)
                {
                  ...
                  case 'Projects':  $m =  app::getFilterProjects(array(),'tasks/index',$params,$filter_by[$table],$sf_user); 
                    break;
                  case 'ProjectsStatus':  $m =  app::getFilterMenuStatusItemsByTable(array(),$table,'Case Status','tasks/index',$params,$filter_by[$table]);
                    break;
