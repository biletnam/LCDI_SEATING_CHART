...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/html/Metrics/core/log/qdPM_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/html/Metrics/core/cache/qdPM/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/html/Metrics/core/apps/qdPM/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'qdPMSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('qdPM8'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/html/Metrics/core/cache/qdPM/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/Metrics/core/apps/qdPM/template',
)));
