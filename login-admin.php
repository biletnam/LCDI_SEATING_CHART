...
<div class='container'>
    <label for='oldpwd' >Password <span class="required">*</span>:</label>
    <input type='password' name='oldpwd' id='oldpwd' maxlength="50" /><br/>
